...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.0, 225.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 696.0, 215.0, 33.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 466.0, 105.0, 478.0, 81.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 660.0, 221.0, 24.0, 22.0 ],
									"style" : "",
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 638.0, 386.0, 85.0, 22.0 ],
									"style" : "",
									"text" : "prepend open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 701.0, 251.0, 194.0, 62.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 701.0, 176.0, 195.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 713.0, 146.0, 69.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 713.0, 68.5, 24.0, 22.0 ],
									"style" : "",
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 713.0, 23.5, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 713.0, 114.5, 89.0, 22.0 ],
									"style" : "",
									"text" : "loadmess path"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 634.0, 434.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 506.0, 694.0, 120.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 294.0, 685.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 532.0, 148.0, 114.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 355.5, 336.0, 30.0, 30.0 ],
									"presentation_rect" : [ 358.0, 333.0, 0.0, 0.0 ],
									"style" : ""
								}
...
,
									"patching_rect" : [ 345.0, 105.0, 51.0, 23.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 315.0, 165.0, 49.0, 22.0 ],
									"style" : "",
									"text" : "gate 1"
								}
